var communityChart = [
    ...
    },
    {
      ...
      color: 'l(1.2,1.2,1.5,0.1)#25066b-#ca3af9'
    },
    {
      value: 15,
      label: 'BTC Token Purchases',
      color: 'l(0, 0.2, 1, 0)#0006ff-#00fff0'
    },
];
    ...
    Donut.prototype.normalElement = function (d) {
        ...
        this.animateArcByStroke(d.arc, d.arc.strokeWidth + 6, d.arc.strokeWidth, 500, function(){
          d.arc.draw.mouseover(function () {
            ...
            updateValue(d, $(s.node).next().find('.value'));
          });
 ...
 ***********************************************************/
var donutSize = 300;
var communityDonut = $('#community-rewards-chart').donut({
    donutSize: donutSize,
    center: {
        x: donutSize / 2,
        y: donutSize / 2
...
communityDonut.startShowAnimation(function(){
    $('button').attr('disabled', false);
});

function updateValue(d, elem){
    $(elem).text(d.value)
...
$( document ).ready(function() {
    $('.community-chart-list>li').hover(
        function() {
            var $p=$(this).parent().children();
            var $index = $p.index(this);
            var d = communityDonut.opts.data[$index];
            var elem = $(this).parent().prev().find('.current-value>.value');
            updateValue(d, elem);
            communityDonut.hightlightElement(d);
        }
    )
});