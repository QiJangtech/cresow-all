...
class TableBuyAdvertisement extends Component {
  render() {
    const {
      data, title
    } = this.props;
    return (
      ...
      <div className="table-responsive">
        ...
        <PaginationContainer tableName="TableBuyAdvertisement" />        
      </div>
      </BoxBody>
      </Box>
...
TableBuyAdvertisement.propTypes = propTypes;
export default sematable('TableBuyAdvertisement', TableBuyAdvertisement, columns, configs);