...
class TransactionTableBuy extends Component {
  render() {
    const {
      // headers: { select, id },
      data,
...
TransactionTableBuy.propTypes = propTypes;
export default sematable('TransactionTableBuy', TransactionTableBuy, columns, configs);