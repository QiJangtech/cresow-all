...
class WalletTableDeposit extends Component {
  render() {
    const {
      // headers: { select, id },
      data,
...
WalletTableDeposit.propTypes = propTypes;
export default sematable('WalletTableDeposit', WalletTableDeposit, columns, configs);